...
-- ============================================================
-- nuke_and_seed.sql
-- 1. Сохраняет все FK-ограничения
-- 2. Удаляет их
-- 3. TRUNCATE всех таблиц (чисто, identity сбрасывается)
-- 4. Заливает тестовые данные
-- 5. Восстанавливает FK-ограничения
-- ============================================================

-- Сброс IDENTITY_INSERT на случай незакрытых сессий
...
-- ============================================================
-- ШАГ 1: Сохраняем все FK и удаляем их
-- ============================================================
IF OBJECT_ID('tempdb..#FKDefs') IS NOT NULL DROP TABLE #FKDefs;

SELECT
    fk.name                                                          AS FKName,
    QUOTENAME(SCHEMA_NAME(tp.schema_id)) + N'.' + QUOTENAME(tp.name) AS ParentTable,
    QUOTENAME(SCHEMA_NAME(tr.schema_id)) + N'.' + QUOTENAME(tr.name) AS RefTable,
    STUFF((
    ...
    STUFF((
        ...
        FROM sys.foreign_key_columns fkc2
        JOIN sys.columns cr
          ON fkc2.referenced_object_id = cr.object_id
...
SELECT @sql += N'ALTER TABLE ' + ParentTable +
               N' DROP CONSTRAINT ' + QUOTENAME(FKName) + N';' + CHAR(10)
FROM #FKDefs;
EXEC(@sql);
PRINT N'FK-ограничения удалены (' + CAST(@@ROWCOUNT AS NVARCHAR) + N')';
GO

-- ============================================================
-- ШАГ 2: TRUNCATE всех пользовательских таблиц
-- ============================================================
DECLARE @sql NVARCHAR(MAX) = N'';
...
BEGIN TRY
    ...
    (2,1,3,N'ИС-21',N'Информационные системы и программирование',  N'09.02.07',2,3,N'Очная',N'Смешанное',4,0,NULL,0);
    SET IDENTITY_INSERT dbo.Groups OFF;

    -- Teachers
    SET IDENTITY_INSERT dbo.Teachers ON;
    INSERT INTO dbo.Teachers (TeacherId,LastName,FirstName,MiddleName,IsDeleted) VALUES
    (1,N'Кузнецова',N'Елена',   N'Владимировна', 0),
    (2,N'Фёдоров',  N'Игорь',   N'Михайлович',   0),
    (3,N'Белова',   N'Наталья', N'Юрьевна',      0),
    (4,N'Тихонов',  N'Андрей',  N'Сергеевич',    0),
    (5,N'Соловьёва',N'Светлана',N'Александровна',0);
    SET IDENTITY_INSERT dbo.Teachers OFF;
    ...
    (1, 4,1,1,   1,N'ЭБ-31-001','2004-03-12',N'г. Москва',  N'Мужской',N'Россия',N'г. Москва, ул. Ленина, д. 10, кв. 5',         N'001-002-003 04',N'4516',N'123456',N'ОВД Советского района г. Москвы',  '2020-03-12',N'ГБОУ СОШ №45 г. Москвы',  N'Средняя школа',N'Бюджет',   N'101','2022-09-01',0),
    (2, 6,1,1,   0,N'ЭБ-31-002','2004-07-25',N'г. Москва',  N'Женский', N'Россия',N'г. Москва, пр. Мира, д. 22, кв. 14',          N'002-003-004 05',N'4517',N'234567',N'ОВД Центрального района г. Москвы','2020-07-25',N'ГБОУ СОШ №112 г. Москвы', N'Средняя школа',N'Бюджет',   N'102','2022-09-01',0),
    (3, 7,1,NULL,0,N'ЭБ-31-003','2004-11-08',N'г. Подольск',N'Мужской',N'Россия',N'г. Подольск, ул. Садовая, д. 3, кв. 7',        N'003-004-005 06',N'4518',N'345678',N'ОВД г. Подольска',                  '2020-11-08',N'МОУ СОШ №5 г. Подольска', N'Средняя школа',N'Бюджет',   NULL,  '2022-09-01',0),
    (4, 8,1,2,   0,N'ЭБ-31-004','2005-02-14',N'г. Балашиха',N'Женский', N'Россия',N'г. Балашиха, ул. Первомайская, д. 18, кв. 3', N'004-005-006 07',N'4519',N'456789',N'ОВД г. Балашихи',                   '2021-02-14',N'МОУ СОШ №2 г. Балашихи',  N'Средняя школа',N'Внебюджет',N'215','2022-09-01',0),
    (5, 5,2,NULL,1,N'ИС-21-001','2005-05-20',N'г. Москва',  N'Мужской',N'Россия',N'г. Москва, ул. Гагарина, д. 7, кв. 11',        N'005-006-007 08',N'4520',N'567890',N'ОВД Южного района г. Москвы',       '2021-05-20',N'ГБОУ СОШ №78 г. Москвы',  N'Средняя школа',N'Внебюджет',NULL,  '2023-09-01',0),
    (6, 9,2,2,   0,N'ИС-21-002','2005-09-03',N'г. Химки',   N'Женский', N'Россия',N'г. Химки, ул. Молодёжная, д. 5, кв. 9',       N'006-007-008 09',N'4521',N'678901',N'ОВД г. Химки',                       '2021-09-03',N'МОУ СОШ №7 г. Химки',    N'Средняя школа',N'Бюджет',   N'312','2023-09-01',0),
    (7,10,2,NULL,0,N'ИС-21-003','2005-12-17',N'г. Мытищи',  N'Мужской',N'Россия',N'г. Мытищи, пр. Олимпийский, д. 14, кв. 22',   N'007-008-009 10',N'4522',N'789012',N'ОВД г. Мытищи',                      '2021-12-17',N'МОУ СОШ №3 г. Мытищи',    N'Средняя школа',N'Бюджет',   NULL,  '2023-09-01',0),
    (8,11,2,1,   0,N'ИС-21-004','2005-04-29',N'г. Люберцы', N'Женский', N'Россия',N'г. Люберцы, ул. Октябрьская, д. 30, кв. 6',  N'008-009-010 11',N'4523',N'890123',N'ОВД г. Люберцы',                      '2021-04-29',N'МОУ СОШ №11 г. Люберцы',  N'Средняя школа',N'Бюджет',   N'105','2023-09-01',0);
    SET IDENTITY_INSERT dbo.Students OFF;
    ...
    (1,1,N'Основная',        NULL,                       NULL,NULL,NULL,                0,0,0,0,0,0,NULL,                                        NULL,                                    N'Собственное жильё',N'Полная семья (отец, мать)',         N'Благополучная',   NULL),
    (2,2,N'Подготовительная',N'Аллергический ринит',     NULL,NULL,NULL,                0,1,0,1,0,0,N'Социальная стипендия',                     N'Повышенная тревожность',               N'Общежитие',        N'Неполная семья (мать)',             N'Малообеспеченная',N'Получает соц. поддержку по потере кормильца'),
    (3,3,N'Основная',        NULL,                       NULL,NULL,NULL,                0,0,1,0,0,0,N'Льгота многодетной семьи',                 NULL,                                    N'Собственное жильё',N'Полная семья (отец, мать, 3 детей)',N'Многодетная',     NULL),
    (4,5,N'Специальная',     N'Сахарный диабет II типа', N'ОВЗ',N'Нет группы',N'МСЭ-2021-001234',0,0,0,0,1,0,N'Повышенная стипендия, бесплатное питание',N'Требует индивидуального сопровождения',N'Собственное жильё',N'Полная семья (отец, мать)',N'Благополучная',N'Контроль уровня сахара'),
    (5,6,N'Основная',        NULL,                       NULL,NULL,NULL,                0,0,0,0,0,0,NULL,                                        NULL,                                    N'Общежитие',        N'Полная семья (отец, мать, брат)',   N'Благополучная',   NULL);
    SET IDENTITY_INSERT dbo.StudentSocialInfo OFF;
    ...
    (1,1,N'Отец',N'Смирнов', N'Андрей',  N'Викторович',   '1975-06-15',N'+79001100001',N'+74951110001',N'smirnov.av@mail.ru', N'г. Москва, ул. Ленина, д. 10, кв. 5',         N'ООО «СтройГрупп»',             N'Инженер',               N'Производственный отдел', N'Высшее техническое',    1,0,1,0),
    (2,1,N'Мать',N'Смирнова',N'Ольга',   N'Николаевна',   '1978-09-22',N'+79001100002',N'+74951110002',N'smirnova.on@mail.ru',N'г. Москва, ул. Ленина, д. 10, кв. 5',         N'ГБУЗ «Городская больница №5»', N'Врач-терапевт',         N'Терапевтическое отделение',N'Высшее медицинское',   0,0,1,0),
    (3,2,N'Мать',N'Козлова', N'Светлана',N'Ивановна',     '1980-03-08',N'+79001100003',N'+74951110003',N'kozlova.si@mail.ru', N'г. Москва, пр. Мира, д. 22, кв. 14',          N'МБОУ СОШ №112',                N'Учитель нач. классов',  N'Начальная школа',         N'Высшее педагогическое', 1,0,1,0),
    ...
    (5,4,N'Мать',N'Лебедева',N'Татьяна', N'Александровна','1982-07-19',N'+79001100005',N'+74951110005',N'lebedeva.ta@mail.ru',N'г. Балашиха, ул. Первомайская, д. 18, кв. 3', N'ПАО «Балашихинский завод»',    N'Бухгалтер',             N'Финансовый отдел',        N'Высшее экономическое',  1,0,1,0),
    (6,5,N'Отец',N'Морозов', N'Евгений', N'Павлович',     '1976-04-05',N'+79001100006',N'+74951110006',N'morozov.ep@mail.ru', N'г. Москва, ул. Гагарина, д. 7, кв. 11',       N'АО «ИнфоТех»',                 N'Системный администратор',N'IT-отдел',               N'Высшее техническое',    1,0,1,0),
    (7,5,N'Мать',N'Морозова',N'Ирина',   N'Сергеевна',    '1979-12-10',N'+79001100007',N'+74951110007',N'morozova.is@mail.ru',N'г. Москва, ул. Гагарина, д. 7, кв. 11',       N'ГБОУ СОШ №78',                 N'Преподаватель математики',N'Отдел точных наук',     N'Высшее педагогическое', 0,0,1,0);
    SET IDENTITY_INSERT dbo.Parents OFF;
    ...
    (1, 1,1,2,5,'2025-01-14',N'Текущая',NULL,0),(2, 1,2,2,4,'2025-01-28',N'Текущая',NULL,0),(3, 1,3,2,5,'2025-02-11',N'Текущая',NULL,0),
    (4, 2,1,2,4,'2025-01-14',N'Текущая',NULL,0),(5, 2,2,2,3,'2025-01-28',N'Текущая',N'Необходимо улучшить знания',0),(6, 2,4,2,4,'2025-02-18',N'Текущая',NULL,0),
    (7, 3,1,2,3,'2025-01-21',N'Текущая',N'Требуется доработка',0),(8, 3,3,2,4,'2025-02-04',N'Текущая',NULL,0),(9, 3,4,2,4,'2025-03-04',N'Текущая',NULL,0),
    (10,4,1,2,4,'2025-01-21',N'Текущая',NULL,0),(11,4,2,2,5,'2025-02-04',N'Текущая',N'Отличный результат',0),(12,4,3,2,4,'2025-03-11',N'Текущая',NULL,0),
    (13,5,5,3,5,'2025-01-15',N'Текущая',NULL,0),(14,5,6,3,5,'2025-02-05',N'Текущая',NULL,0),(15,5,7,3,4,'2025-03-05',N'Текущая',NULL,0),
    (16,6,5,3,4,'2025-01-15',N'Текущая',NULL,0),(17,6,6,3,3,'2025-02-05',N'Текущая',N'Нужно повторить тему JOIN',0),(18,6,8,3,4,'2025-03-19',N'Текущая',NULL,0),
    (19,7,5,3,3,'2025-01-22',N'Текущая',N'Сдан со второй попытки',0),(20,7,7,3,4,'2025-02-12',N'Текущая',NULL,0),(21,7,8,3,4,'2025-03-26',N'Текущая',NULL,0),
    (22,8,5,3,5,'2025-01-22',N'Текущая',NULL,0),(23,8,6,3,4,'2025-02-19',N'Текущая',NULL,0),(24,8,7,3,5,'2025-04-02',N'Текущая',N'Лучший результат в группе',0);
    SET IDENTITY_INSERT dbo.Grades OFF;
    ...
    COMMIT TRANSACTION;
    PRINT N'';
    PRINT N'=== Тестовые данные загружены! Пароль для всех: test123 ===';
    PRINT N'admin / ivanova_m / petrov_a / smirnov_d / morozov_n';
    PRINT N'kozlova_a / novikov_ar / lebedeva_o / zaitseva_d / orlov_m / sokolova_v';
...
-- ============================================================
-- ШАГ 4: Восстанавливаем FK-ограничения
-- ============================================================
DECLARE @sql NVARCHAR(MAX) = N'';
SELECT @sql += N'ALTER TABLE ' + ParentTable +
               N' ADD CONSTRAINT ' + QUOTENAME(FKName) +
               N' FOREIGN KEY (' + ParentCols + N')' +
               N' REFERENCES ' + RefTable + N' (' + RefCols + N');' + CHAR(10)
FROM #FKDefs;
EXEC(@sql);

DROP TABLE #FKDefs;
PRINT N'FK-ограничения восстановлены.';
GO
